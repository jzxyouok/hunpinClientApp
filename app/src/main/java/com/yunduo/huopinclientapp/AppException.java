...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	private boolean handleException(Throwable ex) {
		...
		final Context context = ActManager.getActManager().currentActivity();
		...
		new Thread() {
			public void run() {
				Looper.prepare();
//				UIHelper.sendAppCrashReport(context, crashReport);  //发送崩溃异常报告
				Looper.loop();
			}
	...
	private String getCrashReport(Context context, Throwable ex) {
		PackageInfo pinfo = ((AppAplication)context.getApplicationContext()).getPackageInfo();
