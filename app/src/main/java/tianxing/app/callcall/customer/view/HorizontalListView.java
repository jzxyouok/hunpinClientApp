...
/**
 * Package_name:com.edu.fangqiu.gkww.view
 * Author:zhaoqiang
 * Email:zhaoq_hero@163.com
 * Date:2016/12/26    14：06
 */
//自定义    水平listView 实现  video的  显示和播放
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    {
        mOnItemSelected.onItemSelected(this,getChildAt(position),position,position);
    }
    ...
    private void addAndMeasureChild(final View child, int viewPos)
    {
        ...
        //设置  子view的  宽度 为屏幕的   固定宽度为 屏幕的   1/3
        child.measure(
                MeasureSpec.makeMeasureSpec(getWidth()/3, MeasureSpec.EXACTLY),
